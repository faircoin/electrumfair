...
(
    ...
    cp -fpv "$here/$pkgname/dist/lib/$dlname" "$PROJECT_ROOT/electrumfair" || fail "Could not copy the $pkgname binary to its destination"
    info "$dlname has been placed in the inner 'electrumfair' folder."
)
