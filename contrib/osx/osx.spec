...
a = Analysis([electrum+ MAIN_SCRIPT,
              electrum+'electrumfair/gui/qt/main_window.py',
              electrum+'electrumfair/gui/text.py',
              electrum+'electrumfair/util.py',
              electrum+'electrumfair/wallet.py',
              electrum+'electrumfair/simple_config.py',
              electrum+'electrumfair/bitcoin.py',
              electrum+'electrumfair/dnssec.py',
              electrum+'electrumfair/commands.py',
              electrum+'electrumfair/plugins/cosigner_pool/qt.py',
              electrum+'electrumfair/plugins/email_requests/qt.py',
              electrum+'electrumfair/plugins/trezor/qt.py',
              electrum+'electrumfair/plugins/safe_t/client.py',
              electrum+'electrumfair/plugins/safe_t/qt.py',
              electrum+'electrumfair/plugins/keepkey/qt.py',
              electrum+'electrumfair/plugins/ledger/qt.py',
              electrum+'electrumfair/plugins/coldcard/qt.py',
              ],
             binaries=binaries,
             datas=datas,
